Feature: Covering Patient Forgot Password Page Scenarios
  ...
  @ForgotPassword_001     @patient   @Smoke  @PResetPass
  ...
  @ForgotPassword_002     @patient   @Smoke   @PResetPass
  ...
  @ForgotPassword_003     @patient   @Smoke   @PResetPass
  ...
  @ForgotPassword_004     @patient   @Smoke   @PResetPass
  ...
  @ForgotPassword_005  @patient    @PResetPass
  ...
  @ForgotPassword_006    @patient   @Smoke   @PResetPass
  ...
  @ForgotPassword_007     @patient   @Smoke   @PResetPass
  ...
  @ForgotPassword_008  @patient   @PResetPass
  ...
  @ForgotPassword_009     @patient   @Smoke  @PResetPass
  ...
  @ForgotPassword_010_011    @patient   @Smoke    @PResetPass
  ...
  @ForgotPassword_012     @patient   @Smoke  @PResetPass
  ...
  @ForgotPassword_013  @patient   @PResetPass
  ...
  @ForgotPassword_014  @patient   @PResetPass
  ...
  @ForgotPassword_015  @patient  @PResetPass
  ...
  @ForgotPassword_016  @patient  @PResetPass
  ...
  @ForgotPassword_017  @patient   @PResetPass
  ...
  @ForgotPassword_018  @patient  @PResetPass
  ...
  @ForgotPassword_019      @patient   @Smoke   @PResetPass
