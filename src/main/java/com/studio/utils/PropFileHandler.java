...
public class PropFileHandler extends ConfigFileReader{
	...
	static String filePath1 = "./src/main/resources/dataFile/QA1.properties";
	...
	public static void writeToFile(String property, String value)  {
		try {
			InputStream inPropFile = new FileInputStream(filePath1);
			properties.load(inPropFile);
			inPropFile.close();
			OutputStream outPropFile = new FileOutputStream(filePath1);
